...
| `04_risk_data_model.yaml` | Semantic model backup (YAML) — use if you skip the UI-based semantic view creation |
| `03_data/products.csv` | 12 financial products with risk tier classifications |
| `03_data/loan_originations.csv` | Daily application volume, approvals, denials, funded amounts by region |
| `03_data/loan_performance.csv` | Monthly delinquency snapshots (30/60/90+ DPD) by vintage |
| `03_data/data_quality_metrics.csv` | Daily pipeline health: freshness, dbt tests, null rates, schema changes |
